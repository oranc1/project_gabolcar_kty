...
<div class="car-item ${car.car_type}">
<div class="int_wrap">
   <div class="left-image">
<%--      <img src="${pageContext.request.contextPath }/resources/upload/car/${car.car_file_path}/${car.carFile[0]}" alt="carImage"> --%>
...
<%--       <img src="${pageContext.request.contextPath }/resources/upload/car/${car.car_file_path}/${car.carFiles[0]}" alt="carImage"> --%>
            </div>
